                      ...
                      child: Container(
                          ...
                          child: Expanded(
                              child: GetBuilder<StudentLecturesController>(
                                  builder:
                                      (_) =>
                                          controller1.lecturesToday.isNotEmpty
                                              ? ListView.builder(
                                                  itemCount: controller1
                                                      .lecturesToday.length,
                                                  itemBuilder:
                                                                ...
                                                                title:
                                                                    Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Row(children: [
                                                                              Text(controller1.lecturesToday[index].teacher.user.name.toString()),
                                                                            ]),
                                                                          ],
                                                                        )),
                                                                subtitle: Row(
                      ...
                      child: Container(
                          ...
                          child: Expanded(
                              child: GetBuilder<StudentHomeController>(
                                  builder:
                                      (_) =>
                                          controller.currentLectures.isNotEmpty
                                              ? ListView.builder(
                                                                ...
                                                                title:
                                                                    Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Row(children: [
                                                                              Text(controller.currentLectures[0].unit.stage.name.toString()),
                                                                            ]),
                                                                            Text(controller.currentLectures[0].unit.name.toString()),
                                                                          ],
                                                                        )),
                                                                subtitle: Row(
                                                                  mainAxisAlignment:
