        ...
        <div class="container px-5 py-10 mx-auto bg-white rounded-lg max-w-7xl sm:px-6 lg:px-8">
          ...
          <div class="w-full" wire:loading>
            <div class="flex justify-center items-center">
              <div
                class="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-300"
              ></div>
            </div>
          </div>
                  ...
                  <tr class="bg-gray-50" wire:key="teacher-field-{{ $teacher->id }}">
                            ...
                            <div x-data="{ show: false }">
                                ...
                                <div x-show="show">
                                    <div class="text-gray-600 focus-within:text-gray-400">
                                        <input wire:model="teachers.{{ $i }}.user.name" class="py-3 block w-full text-sm text-gray-400 bg-gray-100 rounded-md px-5 focus:outline-none focus:bg-gray-50 focus:text-gray-900" placeholder="{{ $teacher->user->name }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-data="{ show: false }">
                                ...
                                <div x-show="show">
                                    <div class="mt-1 text-gray-600 focus-within:text-gray-400">
                                        <input type="email" wire:model="teachers.{{ $i }}.user.email" class="py-3 block w-full text-sm text-gray-400 bg-gray-100 rounded-md px-5 focus:outline-none focus:bg-gray-50 focus:text-gray-900" placeholder="{{ $teacher->user->email }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <td class="p-3">
                        <div x-data="{ show: false }">
                            ...
                            <div x-show="show">
                                <div class="text-gray-600 focus-within:text-gray-400">
                                    <input wire:model="teachers.{{ $i }}.speciality" class="py-3 block w-full text-sm text-gray-400 bg-gray-100 rounded-md px-5 focus:outline-none focus:bg-gray-50 focus:text-gray-900" placeholder="{{ $teacher->speciality }}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </td>
