              ...
              <tbody>
                @forelse($people as $person)
                  <tr class="bg-gray-50">
                    ...
                    <td class="p-3">
                      <div class="flex align-items-center">
                        ...
                        <div class="ml-3">
                        <a href="{{ route('trackings', [0, $person->id]) }}" class="text-gray-500 transition hover:text-gray-800 font-bold">
                            {{ $person->name }}
                        </a>
                          <div class="">
                            @switch($person->type)
                    ...
                    <td class="p-3">
                      <button wire:click="selectEditPerson({{$person->id}})" class="text-gray-400 hover:text-gray-600 mr-2">
                  ...
                  @if ($person->id == $editingPerson)
                      <td colspan="6">
                        <livewire:person-edit :personId="$editingPerson" key="{{now()}}" />
                      </td>
                  @endif
                @empty
                <tr class="bg-red-100">
